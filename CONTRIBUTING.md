...
* Ensure all Classes, and Functions are documented appropriately as for the [JSDoc](https://devdocs.io/jsdoc/) standard. See `documentation/README.md` for these instructions.
